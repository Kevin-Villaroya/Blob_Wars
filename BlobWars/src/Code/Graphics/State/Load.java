...
public class Load extends BasicGameState {
	...
	public void render(GameContainer arg0, StateBasedGame arg1, Graphics g) throws SlickException {
		...
		MenuState.zorque.drawString(
				volumeSounds.getX() + volumeSounds.getTaille() / 2
						- MenuState.zorque.getWidth("Volume bruitages") / 2,
				volumeSounds.getY() - MenuState.zorque.getHeight("Volume") - 20, "Volume bruitages", Color.black);

		MenuState.zorque.drawString(volumeBackground.getX()+ volumeBackground.getTaille() / 2
